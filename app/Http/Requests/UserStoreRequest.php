...
class UserStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            /*
             * Blank: the system generates a unique one-time password, shown
             * once to this administrator. Typed: the full central policy,
             * checked against the new holder's name, email and phone.
             */
            'password' => $this->filled('password')
                ? app(PasswordPolicy::class)->rules(null, $this->only(['name', 'email', 'phone_number']))
                : ['nullable'],

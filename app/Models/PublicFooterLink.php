 ...
 */
class PublicFooterLink extends Model
{
    use HasUuidPrimaryKey;

    protected $table = 'public_footer_links';

    protected $fillable = [
        'group', 'label_en', 'label_am', 'type', 'route_name', 'url', 'is_visible', 'is_system', 'sort_order', 'updated_by',
    ];

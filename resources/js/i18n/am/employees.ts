const employees = {
    ...
    import: {
        ...
        templateOrganizationHelp: 'እስከ :max ንቁና ክፍት መደቦች ከተቋም፣ ከክፍልና ከመደብ ስሞች ጋር ይወርዳሉ። ስሞችንና position_reference አይቀይሩ፤ ማጣቀሻው ተመሳሳይ ስም ያላቸውን መደቦች ይለያል። የሠራተኛ መረጃ ይሙሉ፤ ያልተጠቀሙባቸውን ረድፎች ያስወግዱ። ክፍት መደብ ከሌለ መደብ ፈጥረው እንደገና ያውርዱ። የቀድሞ ኮድ የያዙ CSV ፋይሎችም ይሰራሉ።',

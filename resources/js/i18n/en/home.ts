const home = {
    ...
    service_idCards_title: 'ID Cards',
    service_idCards_desc: 'Full card lifecycle management: request, print, issue, activate, replace, and revoke.',
    service_cafeteria_title: 'Cafeteria',
    service_cafeteria_desc: 'Subsidized meal access and transaction tracking for employees at authorized cafeteria providers.',
    service_transfers_title: 'Transfers',
    service_transfers_desc: 'Structured transfer workflow with multi-party confirmation, ensuring continuity of employee identity.',
    service_verification_title: 'ID Verification',
    service_verification_desc: 'Scan or enter a card reference to verify an employee\'s ID and service entitlements in real time.',

const organizationUnits = {
    ...
    copyStructureTitle: 'Copy Organization Unit Structure',
    sourceOrganization: 'Source Organization',
    sourceUnit: 'Source Unit (optional)',
    targetOrganization: 'Target Organization',
    targetParentUnit: 'Target Parent Unit (optional)',
    copyPositions: 'Copy Positions',
    copyFunctionalRelationships: 'Copy Functional Relationships',
    namePrefix: 'Name Prefix',
    nameSuffix: 'Name Suffix',
    copiedSuccessfully: 'Structure copied successfully',
    structureCopied: 'Organization unit structure copied',
    previewUnits: 'Units that will be copied',
    allUnitsWillBeCopied: 'All root units of the source organization will be copied',
    ownerOrganization: 'Owner Organization',
    operatingOrganization: 'Operating Organization',
    hostedUnitHelp: 'This unit belongs to the owner organization functionally but operates within the selected host organization. Job position codes for this unit include both organization codes.',
} as const;

...
export * as enOrganizationalChangeRequests from './en/organizationalChangeRequests';
export * as enOrganizationUnits from './en/organizationUnits';
export * as enOrganizationStructureImport from './en/organizationStructureImport';
...
export * as enServiceFeedback from './en/serviceFeedback';
...
export * as amOrganizationalChangeRequests from './am/organizationalChangeRequests';
export * as amOrganizationUnits from './am/organizationUnits';
export * as amOrganizationStructureImport from './am/organizationStructureImport';
...
export * as amServiceFeedback from './am/serviceFeedback';
